...
async function main() {
    ...
    let item1 = await items.createItem("Brown Trouser Pants", "Its brown pants and it is large", "Open", "h54etn5hn4n", 15, ["4574857389", "75348573", "ngjfdtuvfj"], []);
    let item2 = await items.createItem("Red Shirt", "Its a red shirt and it is large", "Open", "hrvdmkcef", 12, ["56783567", "fdbcnf", "65yrfhde6"], []);
